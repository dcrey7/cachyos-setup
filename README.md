...
- Panel layout tweaks, numbered virtual desktops next to Kickoff, centered taskbar with spacers, non-floating translucent panels, battery percentage, and clock layout.
